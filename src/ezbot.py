'''
🌙 MonoQ Bot Trading Bot Control Panel 
...
action = 0
print('🌙 MonoQ Bot says: slow down, dont trade by hand... take it easy! 🚀')
...
def bot():
    ...
    while action == 0:
        ...
        if pos < .9:
            ...
            pos = n.get_position(symbol)
            if pos < .9:
                print('position closed thanks mono q....')
        ...
        while pos_usd < (.97 * usd_size):
            ...
            try:
                ...
                for i in range(orders_per_open):
                    ...
                    cprint(f'chunk buy submitted of {symbol[-4:]} sz: {chunk_size} you my dawg mono q', 'white', 'on_blue')
                    time.sleep(1)
    ...
    while action == 3:
        ...
        if (price > BREAKOUT_PRICE) and (pos_usd < usd_size):
            ...
            if (pos_usd < usd_size) and (price > BREAKOUT_PRICE):
                ...
                print('breakout entry complete, thanks mono q...')
                time.sleep(15)
