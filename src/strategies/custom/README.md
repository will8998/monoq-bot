# 🌙 MonoQ Bot's Custom Strategies Directory
...
- Use MonoQ Bot's utility functions from nice_funcs.py
...
## Questions?
Check out the example strategy or reach out to Wazuki Musashi for help! 🌙 🚀 