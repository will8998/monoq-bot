...
🌙 MonoQ Bot's Hyperliquid Functions
...
def get_data(symbol, timeframe='15m', bars=100, add_indicators=True):
    """
    🌙 MonoQ Bot's Hyperliquid Data Fetcher
    ...
    if not df.empty:
        ...
        print("✨ Thanks for using MonoQ Bot's Data Fetcher! ✨")
...
if __name__ == "__main__":
    print("\n🌙 MonoQ Bot's Hyperliquid Function Tester")
    print("=" * 50)
    ...
    print("\n✨ Testing complete! MonoQ Bot out! 🌙") 