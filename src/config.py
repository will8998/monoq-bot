"""
🌙 MonoQ Bot's Configuration File
...
# MonoQ Bot's Token Trading List 🚀
# Each token is carefully selected by Wazuki Musashi for maximum moon potential! 🌙
...
# 🌙 MonoQ API Settings
# Set to False if you don't have a MONOQ_API_KEY.
# This will disable Whale, Liquidation, and Funding agents but keep core trading working.
ENABLE_MONOQ_API = True
