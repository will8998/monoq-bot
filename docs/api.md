# 🌙 MonoQ Market Data API Documentation
...
The MonoQ Market Data API (`src/agents/api.py`) provides access to real-time market data. The API is designed to be easy to use while providing powerful features for market analysis and automated trading.
...
```bash
# Create a .env file and add your MonoQ API key
...
api = MonoQAPI()  # Automatically loads API key from .env
```
...
---
*Built with 🌙 by Wazuki Musashi - Making trading data accessible and beautiful*
